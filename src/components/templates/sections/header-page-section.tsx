...
export function HeaderPageSection({ title, subTitle, className, actions }: HeaderPageSectionProps) {
    return (
        <div className={cn("sticky top-0 z-10 flex items-center justify-between bg-background text-foreground py-2 pl-4 pr-4 lg:pr-16 border-b border-sidebar-border shadow", className)}>
            <div>
